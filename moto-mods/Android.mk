...
ifneq ($(filter griffin addison,$(TARGET_DEVICE)),)

include $(CLEAR_VARS)
LOCAL_MODULE := ModFmwekProxyService
LOCAL_MODULE_OWNER := motorola
LOCAL_SRC_FILES := proprietary/priv-app/ModFmwekProxyService/ModFmwekProxyService.apk
...
LOCAL_MODULE_OWNER := motorola
LOCAL_SRC_FILES := proprietary/priv-app/MotCameraMod/MotCameraMod.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
